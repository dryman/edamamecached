...
enum cmd_rescode
{
  ...
  PROTOCOL_BINARY_RESPONSE_VBUCKET_IN_OTHER_SERV = 0x0007,
  PROTOCOL_BINARY_RESPONSE_AUTH_ERROR = 0x08,
  PROTOCOL_BINARY_RESPONSE_AUTH_CONTINUE = 0x09,
  PROTOCOL_BINARY_RESPONSE_UNKNOWN_COMMAND = 0x81,
  PROTOCOL_BINARY_RESPONSE_ENOMEM = 0x82,
  PROTOCOL_BINARY_RESPONSE_NOT_SUPPORTED = 0x0083,
  PROTOCOL_BINARY_RESPONSE_INTERNAL_ERR = 0x0084,
  PROTOCOL_BINARY_RESPONSE_BUSY = 0x0085,
  PROTOCOL_BINARY_RESPONSE_TMP_FAILURE = 0x0086,
  // force rescode to be 2 bytes
  PROTOCOL_BINARY_RESPONSE_RESERVED = 0x0100,
